...
urlpatterns = [
    ...
    path('ingrec-list', views.recipeIngredientsList, name='recipe-ingredient-list'),
    ...
    path('ingredient-by-recipe/<str:pk>', views.ingredientsByRecipeList, name='ingredient-by-recipe'),
